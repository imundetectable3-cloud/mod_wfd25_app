...
window.gameContent = {
    ...
    beginner: {
        ...
        "Chocolate": {
            ...
            correctOrder: ["Cocoa Beans", "Sugar"]
        },
        "Butter": {
    ...
    intermediate: {
        "Yogurt": {
            ...
            correctOrder: ["Milk", "Pasteurization",  "Homogenization", "Bacterial Culture",  "Fermentation"]
        },
        "Cheese": {
            availableIngredients: ["Milk", "Rennet", "Salt", "Bacterial Culture", "Calcium Chloride", "Starter Culture", "Cream", "Whey Protein", "Enzymes", "Preservatives", "Flavoring", "Coloring", "Stabilizers", "Milk Powder", "Minerals"],
        ...
        "Ice Cream": {
            ...
            correctOrder: ["Milk", "Cream", "Mixing", "Pasteurization", "Homogenization", "Freezing"]
        },
        "Chocolate": {
            availableIngredients: ["Cocoa Beans", "Sugar", "Cocoa Butter", "Milk Powder", "Lecithin", "Vanilla", "Nuts", "Dried Fruits", "Flavoring", "Emulsifiers", "Salt", "Preservatives", "Sweeteners", "Minerals", "Vitamins"],
            availableProcesses: ["Roasting", "Grinding", "Mixing", "Conching", "Tempering", "Molding", "Cooling", "Testing", "Packaging", "Quality Control"],
            correctOrder: ["Cocoa Beans", "Roasting", "Grinding", "Conching", "Tempering", "Molding"]
        },
        "Butter": {
            availableIngredients: ["Cream", "Salt", "Cultures", "Water", "Milk Solids", "Preservatives", "Vitamins", "Minerals", "Colors", "Flavoring", "Stabilizers", "Emulsifiers", "Antioxidants", "Proteins", "Enzymes"],
...
function previewGameItems() {
    ...
    if (gameState.currentDifficulty === 'beginner') {
        ...
        // Intermediate: show only Ingredients and Processes, limit to 7
        createCategorySectionPreview('Ingredients', [...productData.availableIngredients].slice(0, 7), categoriesContainer, true);
        createCategorySectionPreview('Processes', [...(productData.availableProcesses || [])].slice(0, 7), categoriesContainer, true);
        ...
        // Expert: show Ingredients, Processes, and Equipment, limit to 7
        createCategorySectionPreview('Ingredients', [...productData.availableIngredients].slice(0, 7), categoriesContainer, true);
        createCategorySectionPreview('Processes', [...(productData.availableProcesses || [])].slice(0, 7), categoriesContainer, true);
        createCategorySectionPreview('Equipment', [...(productData.availableEquipment || [])].slice(0, 7), categoriesContainer, true);
        // Improved alignment: stack vertically, full width
        categoriesContainer.style.display = 'flex';
        categoriesContainer.style.flexDirection = 'column';
        categoriesContainer.style.alignItems = 'stretch';
...
function setupGame() {
    ...
    if (gameState.currentDifficulty === 'beginner') {
        ...
        // Intermediate: show only Ingredients and Processes, limit to 7
        createCategorySection('Ingredients', shuffleArray([...productData.availableIngredients]).slice(0, 7), categoriesContainer, true);
        createCategorySection('Processes', shuffleArray([...(productData.availableProcesses || [])]).slice(0, 7), categoriesContainer, true);
        // Improved alignment: stack vertically, full width
        categoriesContainer.style.display = 'flex';
        categoriesContainer.style.flexDirection = 'column';
        categoriesContainer.style.alignItems = 'stretch';
        ...
        createCategorySection('Ingredients', shuffleArray([...productData.availableIngredients]).slice(0, 7), categoriesContainer, true);
        createCategorySection('Processes', shuffleArray([...(productData.availableProcesses || [])]).slice(0, 7), categoriesContainer, true);
        createCategorySection('Equipment', shuffleArray([...(productData.availableEquipment || [])]).slice(0, 7), categoriesContainer, true);
        // Improved alignment: stack vertically, full width
        categoriesContainer.style.display = 'flex';
        categoriesContainer.style.flexDirection = 'column';
        categoriesContainer.style.alignItems = 'stretch';
